...
color_picker.new = function()
    ...
    local color_picker_img = loadImage("mods/evaisa.skineditor/files/gfx/skins/color_picker.png")

    self.picker_x = color_picker_img.w - 1

    local color_bar_img = loadImage("mods/evaisa.skineditor/files/gfx/skins/color_bar.png")

    for i = 0, color_bar_img.h - 1 do
        local new_image_path = "mods/evaisa.skineditor/files/gfx/skins/pickers/color_picker" .. tostring(i) .. ".png"
    ...
    local picked_color_img = loadImage("mods/evaisa.skineditor/files/gfx/skins/picked_color.png")
    ...
    self.draw = function(x, y)
        ...
        GuiImage(self.gui, new_id(), x, y, "mods/evaisa.skineditor/files/gfx/skins/picked_color.png", 1, 1, 1)
        ...
        GuiZSetForNextWidget(self.gui, -4000)
        GuiImage(self.gui, new_id(), x, y, "mods/evaisa.skineditor/files/gfx/skins/color_bar.png", 1, 1, 1)
        ...
        GuiImage(self.gui, new_id(), bar_cursor_x, bar_cursor_y, "mods/evaisa.skineditor/files/gfx/skins/color_bar_cursor.png", 1, 1, 1)
        
        local picker_cursor_x = (picker_x - container_x - 1) + self.picker_x
        local picker_cursor_y = (picker_y - container_y - 1) + self.picker_y

        GuiZSetForNextWidget(self.gui, -4001)
        GuiImage(self.gui, new_id(), picker_cursor_x - 4, picker_cursor_y - 4, "mods/evaisa.skineditor/files/gfx/skins/color_picker_cursor.png", 1, 1, 1)
