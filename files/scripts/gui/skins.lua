dofile("mods/evaisa.skineditor/files/scripts/gui/image.lua")

local color_picker = dofile("mods/evaisa.skineditor/files/scripts/gui/color_picker.lua")
dofile("mods/evaisa.skineditor/files/scripts/utilities/utils.lua")
local fs = require("fs")
...
skins.init = function()
    ...
    local default_sprite_path = "mods/evaisa.skineditor/files/gfx/skins/player_default.png"
    ...
    self.tools = {
        {
            id = "pencil",
            icon = "mods/evaisa.skineditor/files/gfx/skins/tool_icons/pencil.png",
        ...
        {
            id = "eraser",
            icon = "mods/evaisa.skineditor/files/gfx/skins/tool_icons/eraser.png",
        ...
        {
            id = "picker",
            icon = "mods/evaisa.skineditor/files/gfx/skins/tool_icons/picker.png",
        ...
        {
            id = "fill",
            icon = "mods/evaisa.skineditor/files/gfx/skins/tool_icons/fill.png",
        ...
        {
            id = "replace",
            icon = "mods/evaisa.skineditor/files/gfx/skins/tool_icons/replace.png",
		...
		{
			id = "cosmetics",
			icon = "mods/evaisa.skineditor/files/gfx/skins/tool_icons/cosmetics.png",
			...
			draw = function()
				...
				local slot_w, slot_h = GuiGetImageDimensions(self.gui, "mods/evaisa.skineditor/files/sprites/ui/cosmetics/slot.png")
				...
				for row = 1, rows do
					for slot = 1, slots_per_row do
						...
						if item_index <= item_count then
							...
							GuiImage(self.gui, new_id(), slot_pos_x, slot_pos_y, "mods/evaisa.skineditor/files/sprites/ui/cosmetics/slot.png", alpha, scale, scale)
							...
							if cosmetic_enabled(item.id) then
								...
								GuiImage(self.gui, new_id(), item_x - 4, item_y - 4, "mods/evaisa.skineditor/files/sprites/ui/cosmetics/check.png", 1, 1, 1)
							end
							...
							GuiZSetForNextWidget(self.gui, z)
							GuiImage(self.gui, new_id(), slot_x, slot_y, "mods/evaisa.skineditor/files/sprites/ui/cosmetics/slot.png", 0.5, 1, 1)
						end
        ...
        {
            id = "apply",
            icon = "mods/evaisa.skineditor/files/gfx/skins/tool_icons/apply.png",
            name = "Apply Skin",
    ...
    self.draw = function()
        ...
        if(self.tools[self.selected_tool].draw)then
            self.tools[self.selected_tool].draw()
        end
        ...
        if(mouse_x > player_offset_x and mouse_x < player_offset_x + (player_default_img.w * scale) and mouse_y > player_offset_y and mouse_y < player_offset_y + (player_default_img.h * scale))then
            ...
            GuiImage(self.gui, new_id(), player_x + relative_x * scale, player_y + relative_y * scale, "mods/evaisa.skineditor/files/gfx/skins/draw_cursor.png", 1, 1, 1)
    ...
    self.generate_skin = function(texture, is_content)
        local uv_map = "mods/evaisa.skineditor/files/gfx/skins/player.png"

        if(GameHasFlagRun("super_secret_hamis_mode"))then
            uv_map = "mods/evaisa.skineditor/files/gfx/skins/hamis.png"
        end
        ...
        if(not GameHasFlagRun("super_secret_hamis_mode"))then
            local arm_uv_map = "mods/evaisa.skineditor/files/gfx/skins/player_arm.png"
    ...
    self.apply_skin_to_entity = function(entity)
    ...
    self.apply_skin = function()
		...
		for i, player in ipairs(players)do
			...
			cosmetics_handler.ApplyCosmeticsList(player, self.selected_cosmetics)
		end
